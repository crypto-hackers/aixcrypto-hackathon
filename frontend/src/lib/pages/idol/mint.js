...
async function mint(tokenURI) {
    ...
    const contract = new web3.eth.Contract(
        nft48Abi,
        '0x2B6e9230C79cB8d10E78c10C49278Bf7C8d9919b'
    );
